<div id="historico-remocao" class="lf-content">
    ...
    <div class="lf-container lf-text-center">
        <div class="row">
            <div class="col-lg-12">
                <?= $this->Form->control('Pesquisa', ['class' => 'form-control', 'id'=>'search-remocao-field']) ?>
            </div>
        </div>
        <div class="lf-table">
        ...
        <div class="col-lg-12 lf-margin-medium-top lf-margin-small-bottom">
            Qtde / Peso: <strong id="historico_remocao_total"> 0 / 0</strong>
        </div>
    </div>
</div>
