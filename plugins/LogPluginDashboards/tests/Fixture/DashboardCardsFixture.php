 ...
 */
class DashboardCardsFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'controller' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'consulta_coluna_dado' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'dashboard_cards_ibfk_1' => ['type' => 'foreign', 'columns' => ['dashboard_id'], 'references' => ['dashboards', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'consulta_coluna_dado' => 'Lorem ipsum dolor sit amet',
                'dashboard_id' => 1,
            ],
        ];
        parent::init();
