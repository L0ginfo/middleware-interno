...
/**
 * TabPrecosValidaPerArmsFixture
 */
class TabPrecosValidaPerArmsFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'tab_preco_per_arm_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_constraints' => [
            ...
            'tab_precos_valida_per_arms_ibfk_1' => ['type' => 'foreign', 'columns' => ['tab_preco_per_arm_id'], 'references' => ['tabelas_precos_periodos_arms', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'tab_precos_valida_per_arms_ibfk_2' => ['type' => 'foreign', 'columns' => ['campo_sistema_id'], 'references' => ['sistema_campos', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'tab_precos_valida_per_arms_ibfk_3' => ['type' => 'foreign', 'columns' => ['operador_id'], 'references' => ['operadores', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
