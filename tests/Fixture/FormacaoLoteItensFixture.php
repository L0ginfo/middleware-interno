...
/**
 * FormacaoLoteItensFixture
 */
class FormacaoLoteItensFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'formacao_lote_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_constraints' => [
            ...
            'formacao_lote_itens_ibfk_1' => ['type' => 'foreign', 'columns' => ['ordem_servico_id'], 'references' => ['ordem_servicos', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'formacao_lote_itens_ibfk_2' => ['type' => 'foreign', 'columns' => ['unidade_medida_id'], 'references' => ['unidade_medidas', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'formacao_lote_itens_ibfk_3' => ['type' => 'foreign', 'columns' => ['documento_mercadoria_item_id'], 'references' => ['documentos_mercadorias_itens', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'formacao_lote_itens_ibfk_4' => ['type' => 'foreign', 'columns' => ['embalagem_id'], 'references' => ['embalagens', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'formacao_lote_itens_ibfk_5' => ['type' => 'foreign', 'columns' => ['produto_id'], 'references' => ['produtos', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'formacao_lote_itens_ibfk_6' => ['type' => 'foreign', 'columns' => ['endereco_id'], 'references' => ['enderecos', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'formacao_lote_itens_ibfk_7' => ['type' => 'foreign', 'columns' => ['status_estoque_id'], 'references' => ['status_estoques', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
