...
/**
 * NotaFiscalCfopsFixture
 */
class NotaFiscalCfopsFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'nota_fiscal_cfops_ibfk_1' => ['type' => 'foreign', 'columns' => ['nota_fiscal_id'], 'references' => ['nota_fiscais', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
