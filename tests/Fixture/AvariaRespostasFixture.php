...
/**
 * AvariaRespostasFixture
 */
class AvariaRespostasFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'avaria_respostas_ibfk_1' => ['type' => 'foreign', 'columns' => ['avaria_id'], 'references' => ['avarias', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
