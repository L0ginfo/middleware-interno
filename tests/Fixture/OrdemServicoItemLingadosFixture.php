...
/**
 * OrdemServicoItemLingadosFixture
 */
class OrdemServicoItemLingadosFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'qtde' => ['type' => 'decimal', 'length' => 18, 'precision' => 3, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => ''],
        'peso' => ['type' => 'decimal', 'length' => 18, 'precision' => 3, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => ''],
        ...
        '_constraints' => [
            ...
            'ordem_servico_item_lingados_ibfk_1' => ['type' => 'foreign', 'columns' => ['ordem_servico_id'], 'references' => ['ordem_servicos', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'ordem_servico_item_lingados_ibfk_2' => ['type' => 'foreign', 'columns' => ['sentido_id'], 'references' => ['sentidos', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'ordem_servico_item_lingados_ibfk_3' => ['type' => 'foreign', 'columns' => ['terno_id'], 'references' => ['ternos', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'ordem_servico_item_lingados_ibfk_4' => ['type' => 'foreign', 'columns' => ['resv_id'], 'references' => ['resvs', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'ordem_servico_item_lingados_ibfk_5' => ['type' => 'foreign', 'columns' => ['plano_carga_porao_id'], 'references' => ['plano_carga_poroes', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
