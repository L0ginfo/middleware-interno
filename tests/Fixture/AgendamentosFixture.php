...
class AgendamentosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'agendamentos_ibfk_1' => ['type' => 'foreign', 'columns' => ['usuario_id'], 'references' => ['usuarios', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'data_inicio' => '2016-05-31 10:33:35',
            'data_fim' => '2016-05-31 10:33:35',
            'usuario_id' => 1
        ],
    ];
}
