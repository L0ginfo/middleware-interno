...
/**
 * OrdemServicoUnitizacoesFotosFixture
 */
class OrdemServicoUnitizacoesFotosFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'fita' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'ordem_servico_unitizacoes_fotos_ibfk_1' => ['type' => 'foreign', 'columns' => ['usuario_id'], 'references' => ['usuarios', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'ordem_servico_unitizacoes_fotos_ibfk_2' => ['type' => 'foreign', 'columns' => ['anexo_id'], 'references' => ['anexos', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created_at' => 1626261047,
                'updated_at' => 1626261047,
            ],
        ];
        parent::init();
    }
