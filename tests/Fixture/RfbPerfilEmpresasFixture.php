...
/**
 * RfbPerfilEmpresasFixture
 */
class RfbPerfilEmpresasFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'rfb_perfil_empresas_ibfk_1' => ['type' => 'foreign', 'columns' => ['empresa_id'], 'references' => ['empresas', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'rfb_perfil_empresas_ibfk_2' => ['type' => 'foreign', 'columns' => ['perfil_id'], 'references' => ['rfb_perfis', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
