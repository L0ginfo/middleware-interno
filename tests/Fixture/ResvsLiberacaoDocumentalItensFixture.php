...
/**
 * ResvsLiberacaoDocumentalItensFixture
 */
class ResvsLiberacaoDocumentalItensFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'resvs_liberacao_documental_itens_ibfk_1' => ['type' => 'foreign', 'columns' => ['resv_liberacao_documental_id'], 'references' => ['resvs_liberacoes_documentais', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'resvs_liberacao_documental_itens_ibfk_2' => ['type' => 'foreign', 'columns' => ['liberacao_documental_item_id'], 'references' => ['liberacoes_documentais_itens', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'resvs_liberacao_documental_itens_ibfk_3' => ['type' => 'foreign', 'columns' => ['liberacao_documental_transportadora_item_id'], 'references' => ['liberacao_documental_transportadora_itens', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
