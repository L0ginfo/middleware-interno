...
class LogsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_logs_usuarios1_idx' => ['type' => 'index', 'columns' => ['created_by'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_logs_usuarios1' => ['type' => 'foreign', 'columns' => ['created_by'], 'references' => ['usuarios', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
