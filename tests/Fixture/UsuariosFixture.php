...
class UsuariosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'senha' => ['type' => 'string', 'fixed' => true, 'length' => 40, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        'ativo' => ['type' => 'integer', 'length' => 4, 'unsigned' => false, 'null' => false, 'default' => '1', 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'cpf' => ['type' => 'string', 'fixed' => true, 'length' => 11, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        ...
        '_indexes' => [
            'fk_usuarios_empresas1_idx' => ['type' => 'index', 'columns' => ['empresa_id'], 'length' => []],
            'fk_usuarios_perfis1_idx' => ['type' => 'index', 'columns' => ['perfil_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'email_UNIQUE' => ['type' => 'unique', 'columns' => ['email'], 'length' => []],
            'cpf_UNIQUE' => ['type' => 'unique', 'columns' => ['cpf'], 'length' => []],
            'fk_usuarios_empresas1' => ['type' => 'foreign', 'columns' => ['empresa_id'], 'references' => ['empresas', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'fk_usuarios_perfis1' => ['type' => 'foreign', 'columns' => ['perfil_id'], 'references' => ['perfis', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
