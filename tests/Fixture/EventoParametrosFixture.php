...
/**
 * EventoParametrosFixture
 */
class EventoParametrosFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'evento_parametros_ibfk_1' => ['type' => 'foreign', 'columns' => ['operador_id'], 'references' => ['operadores', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
