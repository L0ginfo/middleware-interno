...
class dbportal {
    ...
    public static function get()
    {
        ...
        self::$db = new PDO("mysql:host=localhost;dbname=portaltst;charset=utf8", 'root', 'senha1');
    ...
    public static function insert($table, $fields)
    {
        ...
        error_log(vsprintf(str_replace('?', "'%s'", $sql), $params));
        $stmt = $db->prepare($sql);
