...
return [
	...
	'nfse-itajai-url' => 'http://nfse.itajai.sc.gov.br/NFES?nfp_numero=%s&nfp_serie=%s&nfp_tipo=1&cdt_cnpjcpf=%s&chave_validacao=%s',
    ...
    'mail-profiles' => [
        ...
        'liberacao' => [
            'host' => 'smtp.office365.com',
            'auth' => 'login',
            'username' => 'liberacaodocumental@barradorio.com.br',
            'password' => 'Funo1027',
            'ssl' => 'tls',
            'port' => '587',
            'from_email' => 'liberacaodocumental@barradorio.com.br',
            'from_name' => "Portal $empresa",
            // 'bcc' => 'faturamento@barradorio.com.br',
            //'reply_name' => '',
            //'reply_to' => '',
