...
$dbconn = new PDO("mysql:host=localhost;dbname=tst_barra_portal;charset=utf8", 'root', 'senha1');
...
$sql = 'select * from queue_email where DATE_PUBLISHED > ? and DATE_PUBLISHED < ? and success = 0 and max_attempts > attempts order by DATE_PUBLISHED limit 20';
$params = [date('Y-m-d H:i:s', strtotime("-1 day")), date('Y-m-d H:i:s')];
