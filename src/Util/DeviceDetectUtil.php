...
class DeviceDetectUtil 
{

    private $userAgent = "";

    private $devices = array(
        "Computador" => array("msie 10", "msie 9", "msie 8", "windows.*firefox", "windows.*chrome", "x11.*chrome", "x11.*firefox", "macintosh.*chrome", "macintosh.*firefox", "opera"),
        "Tablet" => array("tablet", "android", "ipad", "tablet.*firefox"),
        "Dispositivo Móvel" => array("mobile ", "android.*mobile", "iphone", "ipod", "opera mobi", "opera mini"),
        "bot" => array("googlebot", "mediapartners-google", "adsbot-google", "duckduckbot", "msnbot", "bingbot", "ask", "facebook", "yahoo", "addthis"),
        "Console" => array("ps2", "playstation", "xbox", "wii", "nintendo 3?ds")
    );

    private $deviceType = "";
    private $deviceMatched = "";
        ...
        foreach($this->devices as $deviceType => $devices) {
            foreach($devices as $device) {
                if(preg_match("/" . $device . "/i", $this->userAgent)) {
                    ...
                    $this->deviceMatched = $this->userAgent;
                }
            }
        }
    ...
    public function getDeviceMatched() { return $this->deviceMatched; }
