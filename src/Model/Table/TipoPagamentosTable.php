 ...
 * @method \App\Model\Entity\TipoPagamento newEntity($data = null, array $options = [])
 ...
 * @method \App\Model\Entity\TipoPagamento[] patchEntities($entities, array $data, array $options = [])
