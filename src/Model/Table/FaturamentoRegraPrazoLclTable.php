 ...
 *
 */
class FaturamentoRegraPrazoLclTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->table('faturamento_regra_prazo_lcl');
    ...
    {
        $tabela = 'faturamento_regra_prazo_lcl';
        $campos = ['id',
            'tipo_empresa_id',
            'empresa_id',
    ...
    public function afterDelete($deletado)
    {
        ...
        if (@$deletado->data['entity']->id) {
            $sql = "DELETE faturamento_regra_prazo_lcl WHERE id = " . $deletado->data['entity']->id;
        }
        $conn->query($sql);
    }
}
