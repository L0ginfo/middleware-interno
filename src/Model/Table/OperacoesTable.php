 ...
 * @method \App\Model\Entity\Operacao|false save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\Operacao saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
