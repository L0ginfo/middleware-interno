 ...
 * @method \App\Model\Entity\Pais|false save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\Pais saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
