...
/**
 * ProgramacaoLiberacaoDocumentalItem Entity
 *
 * @property int $id
 * @property int $programacao_liberacao_documental_id
 * @property int $liberacao_documental_item_id
 * @property int|null $liberacao_documental_transportadora_item_id
 *
 * @property \App\Model\Entity\ProgramacaoLiberacaoDocumental $programacao_liberacao_documental
 ...
 */
class ProgramacaoLiberacaoDocumentalItem extends Entity
{
    /**
